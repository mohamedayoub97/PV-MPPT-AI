        ...
        >
          <div
            ...
            className={cn(
              ...
              isLoading && "border-primary-cyan shadow-[0_0_15px_rgba(34,211,238,0.3)]",
              className
            )}
...
const CustomDivider: React.FC = () => (
  <div className="relative h-6 w-[1.5px] mx-1">
    <div
      className="absolute inset-0 bg-gradient-to-t from-transparent via-primary-cyan/70 to-transparent rounded-full"
    />
  </div>
);
...
export const PromptInputBox = React.forwardRef((props: PromptInputBoxProps, ref: React.Ref<HTMLDivElement>) => {
  const { onSend = () => {}, isLoading = false, placeholder = "Demandez n'importe quoi sur le MPPT...", className } = props;
  ...
  return (
    <>
      <PromptInput
        ...
        className={cn(
          "w-full bg-[#1F2023]/90 backdrop-blur-xl border-[#444444] shadow-[0_8px_30px_rgba(0,0,0,0.4)] transition-all duration-300 ease-in-out",
      ...
      >
        ...
        <PromptInputActions className="flex items-center justify-between gap-2 p-0 pt-2">
          ...
          >
            <PromptInputAction tooltip="Télécharger une image">
              <button
            ...
            <div className="flex items-center">
              <button
                ...
                className={cn(
                  ...
                  showSearch
                    ? "bg-[#1EAEDB]/20 border-[#1EAEDB] text-[#1EAEDB]"
              ...
              >
                <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                  ...
                  >
                    <BrainCog className={cn("w-4 h-4", showThink ? "text-primary-cyan" : "text-inherit")} />
                  </motion.div>
                </div>
                <AnimatePresence>
                  {showThink && (
                    <motion.span
                      ...
                      animate={{ width: "auto", opacity: 1 }}
                      exit={{ width: 0, opacity: 0 }}
                      className="text-xs overflow-hidden whitespace-nowrap text-primary-cyan"
                    >
                      Penser
                    </motion.span>
                  )}
              ...
              >
                <div className="w-5 h-5 flex items-center justify-center flex-shrink-0">
                  ...
                  >
                    <FolderCode className={cn("w-4 h-4", showCanvas ? "text-accent-purple" : "text-inherit")} />
                  </motion.div>
                </div>
                <AnimatePresence>
                  {showCanvas && (
                    <motion.span
                      ...
                      animate={{ width: "auto", opacity: 1 }}
                      exit={{ width: 0, opacity: 0 }}
                      className="text-xs overflow-hidden whitespace-nowrap text-accent-purple"
                    >
                      Canvas
                    </motion.span>
                  )}
            ...
            <Button
              ...
              className={cn(
                ...
                isRecording
                  ...
                  : "bg-transparent text-[#9CA3AF] hover:bg-white/10 hover:text-[#D1D5DB]"
              )}
              onClick={() => {
